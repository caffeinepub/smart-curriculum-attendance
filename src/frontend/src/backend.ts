...
export class Backend implements backendInterface {
    ...
    async addTestScore(arg0: string, arg1: bigint, arg2: bigint, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.addTestScore(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurriculum(arg0: string): Promise<Array<CurriculumTopic>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurriculum(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTestQuestions(arg0: string): Promise<Array<TestQuestion>> {
        if (this.processError) {
            try {
    ...
    async getTestScores(): Promise<Array<TestScore>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTestScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markAttendance(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
